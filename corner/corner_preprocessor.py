...
class CornerPreprocessor():
    ...
    def forward(self, batch_img):
        ...
        #sin_img = img_np.transpose(1,2,0) * 255
        sin_img = img_np * 255
...
# test part
cornerdetector = CornerPreprocessor()
image = np.array(Image.open('1.bmp').convert("RGB"))
print(image.shape)
img_tensor = torch.from_numpy(image)
print(img_tensor.shape) # <class 'torch.Tensor'
cornermap = cornerdetector.forward(img_tensor)
print(cornermap.shape)
print(cornermap)
